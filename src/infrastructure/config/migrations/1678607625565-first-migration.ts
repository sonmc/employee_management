...
export class firstMigration1678607625565 implements MigrationInterface {
    name = 'firstMigration1678607625565'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`dob\` datetime NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`last_login\` datetime NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`hash_refresh_token\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users_kanbans\` DROP COLUMN \`user_shared\``);
        await queryRunner.query(`ALTER TABLE \`users_kanbans\` DROP COLUMN \`joined_date\``);
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`hash_refresh_token\``);
